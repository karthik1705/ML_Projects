...
MODEL_PATH = "../Gen AI/catboost_churn_model/catboost_model.cbm"
DATA_PATH = "../Gen AI/catboost_churn_model/data/churn_data_regulated.parquet"
...
def main():
    ...
    X_train = load_x_y("../Gen AI/catboost_churn_model/data/X_train.pkl")
    X_test = load_x_y("../Gen AI/catboost_churn_model/data/X_test.pkl")
    y_train = load_x_y("../Gen AI/catboost_churn_model/data/y_train.pkl")
    y_test = load_x_y("../Gen AI/catboost_churn_model/data/y_test.pkl")
